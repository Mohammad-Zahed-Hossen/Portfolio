    ...
    >
      ...
      {prev ? (
        <Link
          ...
          className="group rounded-lg border border-border bg-surface p-4 sm:p-5 flex flex-col justify-between hover:border-accent/80 focus-ring transition-colors"
        >
          ...
          <div className="text-sm sm:text-base font-bold text-foreground group-hover:text-accent transition-colors line-clamp-1">
            {prev.title}
          </div>
      ...
      {next ? (
        <Link
          ...
          className="group rounded-lg border border-border bg-surface p-4 sm:p-5 flex flex-col justify-between items-start sm:items-end text-left sm:text-right hover:border-accent/80 focus-ring transition-colors"
        >
          <div className="flex items-center gap-1.5 text-xs font-mono text-muted mb-1">
